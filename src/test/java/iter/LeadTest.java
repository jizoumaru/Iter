...
public class LeadTest {
	...
	public void testEmpty() {
		var iter = Iter.empty().lead(1);
		assertFalse(iter.hasNext());
	}

	@Test
	public void testSome() {
		var iter = Iter.of(1, 2, 3, 4, 5, 6).lead(3);
		...
		assertEquals(new ValueLead<Integer>(4, null), iter.next());
		assertEquals(new ValueLead<Integer>(5, null), iter.next());
		assertEquals(new ValueLead<Integer>(6, null), iter.next());
		assertFalse(iter.hasNext());
	}
